-- Supabase Database Schema for Personal Portfolio CMS (Fixed Version)
...
-- Enable RLS on our custom tables (not auth.users)
...
-- Create policies for admin write access (allow all for now)
