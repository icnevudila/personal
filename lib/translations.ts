export const translations = {
  tr: {
    ...
    hero: {
      ...
      description: 'Modern UI/UX prensiplerini kullanarak sakin, insan odaklı web siteleri tasarlıyorum. Sezgisel düzenler, dengeli renk kullanımı ve görsel hikaye anlatan tasarım sistemleri üzerine çalışıyorum. Tasarımın minimal, kullanıcı dostu ve estetik olması gerektiğine inanıyorum.',
    ...
    about: {
      title: 'Hakkımda',
      description1: 'Yaratıcı düşünceyi teknolojiyle birleştirerek sade, etkileyici arayüzler tasarlıyorum. Tasarımın teknolojiyle birleştiği yerde, kullanıcıların kendini rahat hissettiği deneyimler yaratmak için çalışıyorum.',
      description2: 'ChatGPT, Midjourney, GitHub Copilot, Figma AI ve diğer AI araçlarını kullanarak sezgisel düzenler, duygusal renk dengesi ve görsel hikaye anlatan tasarım sistemleri üretiyorum. Tasarımın basit, sakin ve zeki hissettirmesi gerektiğine inanıyorum.',
      description3: 'Teknolojiyle güçlendirilmiş ama lezzetle yönlendirilmiş tasarımlar üzerine çalışıyorum. AI araçları yaratıcı sürecimi hızlandırıyor ve daha etkili iş akışları geliştirmeme katkı sağlıyor.',
      stats: {
        years: 'Yıl Deneyim',
